...
//判断牌型等级
func GradePoker(ShunZi string, Same string, Consecutive string, AlonePoker string, DoubleArray [][] int) (GradeResult int, NameResult string) {
	var Grade int
	var Name string

	if ShunZi == "顺子" && Same == "同花" && DoubleArray [0][0] == 14 &&DoubleArray[1][0]==13{
		Grade = 10
		Name = "皇家同花"
